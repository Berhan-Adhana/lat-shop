  ...
  return (
    <footer className={s.footer}>
      <div className={s.footerInner}>
        <div>
          ...
          <p className={s.footerTagline}>
            Handcrafted African gifts, jewelry, books &amp; accessories.<br />
      ...
      <div className={s.footerBottom}>
        <p>© {new Date().getFullYear()} Lat Shop. All rights reserved. Calgary, Canada.</p>
        ...
        <div className={s.paymentIcons}>
          {["Visa", "Mastercard", "PayPal", "Apple Pay"].map((p) => (
            <span key={p} className={s.paymentBadge}>{p}</span>
          ))}
        </div>
      </div>
    </footer>
